...
The easiest way to access the content is via [the static web site built from this repository](https://github.com/alterity-git/building-inclusive-open-source-software).
